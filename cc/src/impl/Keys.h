...
public:
	...
	Kt Shift_L = mkuq<Key>("Shift_L", 16);
	Kt Shift_R = mkuq<Key>("Shift_R", 16);
	Kt Ctrl_L = mkuq<Key>("Ctrl_L", 17);
	Kt Ctrl_R = mkuq<Key>("Ctrl_R", 17);
	Kt Alt_L = mkuq<Key>("Alt", 18);
	Kt Alt_R = mkuq<Key>("Alt", 18);
